...
namespace RapidExcel.Benchmarks
{
    [MemoryDiagnoser]
    ...
    public class ExcelImportBenchmark
    {
        ...
        {
            _exporter.ExportSheets(_parsedDataMultipleSheets, $"{Path.GetRandomFileName}.xlsx");
        }

        [Benchmark]
        public void ExportTest()
        {
            _exporter.ExportSheet(_parsedData, exportSingleFileName);
        }
    }
}
